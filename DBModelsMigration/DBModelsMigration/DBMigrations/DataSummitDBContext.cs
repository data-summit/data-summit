        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PaperOrientations>(entity =>
            {
                entity.HasKey(e => e.PaperOrientationId)
                    .HasName("PK__PaperOri__22B448247EE958C1");
            ...
            modelBuilder.Entity<Points>(entity =>
            {
                ...
                entity.HasOne(d => d.DrawingFeature)
                    .WithMany(p => p.Points)
                    .HasForeignKey(d => d.DrawingFeatureId)
                    .HasConstraintName("FK_Center_DrawingFeatures");
            });
            ...
            modelBuilder.Entity<Rectangles>(entity =>
            {
                entity.HasKey(e => e.RectangleId)
                    .HasName("PK_RectangleId");
                ...
                entity.HasOne(d => d.Sentence)
                    ...
                    .HasForeignKey(d => d.SentenceId)
                    .HasConstraintName("FK_Rectangles_Sentences");
            });
            ...
            modelBuilder.Entity<TaskDurations>(entity =>
            {
                entity.HasKey(e => e.TaskDurationId)
                    .HasName("PK_TaskDurationId");
                ...
                entity.HasOne(d => d.Drawing)
                    .WithMany(p => p.TaskDurations)
                    .HasForeignKey(d => d.DrawingId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_TaskDurations_Drawings");
            });
