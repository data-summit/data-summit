...
namespace DataSummitTests
{
    ...
    public class StandardAttributeTests
    {
        ...
        public void Create_new_standardAttribute()
        {
            ...
            DataSummitModels.StandardAttributes standardAttribute = new DataSummitModels.StandardAttributes
            {
                StandardAttributeId = 1,
                Name = "Unit Test StandardAttribute",
                ProfileAttributes = new List<DataSummitModels.ProfileAttributes> { profileAttribute }
            };

            var mockStandardAttributesDbSet = new Mock<DbSet<DataSummitModels.StandardAttributes>>();
            ...
            mockStandardAttributesDbSet.Verify(m => m.Add(It.IsAny<DataSummitModels.StandardAttributes>()), Times.Once());
        ...
        public void Get_standardAttribute_by_id()
        {
            ...
            var testStandardAttributes = new List<DataSummitModels.StandardAttributes>
            {
                new DataSummitModels.StandardAttributes
                {
                    StandardAttributeId = 1,
            ...
            var mockStandardAttributeDbSet = new Mock<DbSet<DataSummitModels.StandardAttributes>>();
            mockStandardAttributeDbSet.As<IQueryable<DataSummitModels.StandardAttributes>>().Setup(m => m.Provider).Returns(testStandardAttributes.Provider);
            mockStandardAttributeDbSet.As<IQueryable<DataSummitModels.StandardAttributes>>().Setup(m => m.Expression).Returns(testStandardAttributes.Expression);
            mockStandardAttributeDbSet.As<IQueryable<DataSummitModels.StandardAttributes>>().Setup(m => m.ElementType).Returns(testStandardAttributes.ElementType);
            mockStandardAttributeDbSet.As<IQueryable<DataSummitModels.StandardAttributes>>().Setup(m => m.GetEnumerator()).Returns(testStandardAttributes.GetEnumerator());
