...
namespace DataSummitTests
{
    ...
    public class CompanyTest
    {
        ...
        public void Create_new_company()
        {
            ...
            var mockCompanyDbSet = new Mock<DbSet<DataSummitModels.DB.Company>>();
            ...
            var mockCompany = new DataSummitHelper.Classes.Company(mockContext.Object);

            mockCompany.CreateCompany(company);

            mockCompanyDbSet.Verify(m => m.Add(It.IsAny<DataSummitModels.DB.Company>()), Times.Once());
        ...
        {
            var testCompanies = new List<DataSummitModels.DB.Company>
            {
                new DataSummitModels.DB.Company
                {
                    CompanyId = 1,
            ...
            var mockCompanyDbSet = new Mock<DbSet<DataSummitModels.DB.Company>>();
            mockCompanyDbSet.As<IQueryable<DataSummitModels.DB.Company>>().Setup(m => m.Provider).Returns(testCompanies.Provider);
            mockCompanyDbSet.As<IQueryable<DataSummitModels.DB.Company>>().Setup(m => m.Expression).Returns(testCompanies.Expression);
            mockCompanyDbSet.As<IQueryable<DataSummitModels.DB.Company>>().Setup(m => m.ElementType).Returns(testCompanies.ElementType);
            mockCompanyDbSet.As<IQueryable<DataSummitModels.DB.Company>>().Setup(m => m.GetEnumerator()).Returns(testCompanies.GetEnumerator());
            ...
            var mockCompanyService = new DataSummitHelper.Classes.Company(mockContext.Object);
